...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() { //Bir ıtem'a tıklandığında ne olacağını belirleyen method. Değişim dinleyici denebilir.
            @Override
